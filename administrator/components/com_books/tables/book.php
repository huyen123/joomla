...
class BooksTableBook extends JTable
{
	...
	public function store($updateNulls = false)
	{
		...
		{
			$this->setError(JText::_('COM_BOOKS_ERROR_UNIQUE_ALIAS'));
			return false;
		}
	...
	public function check()
	{
		...
		if (trim($this->title) == '')
		{
			$this->setError(JText::_('COM_BOOKS_ERR_TABLES_TITLE'));
			return false;
		}
		...
		$query = $this->_db->getQuery(true)
			...
			->from($this->_db->quoteName('#__books'))
		...
		{
			$this->setError(JText::_('COM_BOOKS_ERR_TABLES_NAME'));
			return false;
		}
